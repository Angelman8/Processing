...
void setup() 
{
  numDots = (int)(displayWidth*displayHeight*.000098);
...
void draw() 
{
  if (!paused)
  {
    ...
    if (AUDIO_REACTIVE) {
      ...
      distMod = displayWidth*displayHeight*0.00004 + inputMod + beatKick;

      strokeWeight(map(inputMod, 0, 100, 0.2, 1.8));
